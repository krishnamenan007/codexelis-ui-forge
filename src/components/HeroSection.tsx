      ...
      <div className="container mx-auto px-4">
        <div className="grid lg:grid-cols-2 gap-12 items-center min-h-[80vh]">
          <div className="space-y-8">
            <div className="inline-block px-3 py-1.5 sm:px-4 sm:py-2 bg-primary/10 rounded-full text-[#8A0C1E] font-medium text-sm sm:text-base mt-10 sm:mt-0">
              TRUSTED IT & TECH SOLUTION FOR YOU
            </div>
            <h1 className="text-4xl lg:text-6xl font-bold text-foreground leading-relaxed tracking-tight font-title">
