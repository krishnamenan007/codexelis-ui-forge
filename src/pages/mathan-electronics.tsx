...
const MathanElectronics = () => {
  const project = {
    ...
    // showcaseImages: [
    //   {
    //     src: "/lovable-uploads/mathanelec.png",
                  ...
                  <ul className="space-y-2 ml-7">
                    {feature.features.map((item, itemIndex) => (
                      <li key={itemIndex} className="text-sm text-muted-foreground flex items-start gap-2">
                        <CheckCircle className="w-4 h-4 text-[#8A0C1E] mt-0.5 flex-shrink-0" />
                        <span>{item}</span>
                      </li>
                    ))}
                  </ul>
        ...
        <Card className="mb-8">
          <CardHeader>
            <div className="flex items-center gap-3 mb-2">
              ...
              <CardTitle className="text-2xl">ROI & Business Impact</CardTitle>
            </div>
          </CardHeader>
          <CardContent>
            <div className="grid md:grid-cols-2 gap-8">
              <div>
                ...
                <ul className="space-y-2">
                  {project.roiMetrics.quantifiableBenefits.map((item, index) => (
                    <li key={index} className="text-sm text-muted-foreground flex items-start gap-2">
                      <CheckCircle className="w-4 h-4 text-[#8A0C1E] mt-0.5 flex-shrink-0" />
                      <span>{item}</span>
                    </li>
              ...
              <div>
                <h4 className="font-semibold text-foreground mb-3">Cost Savings</h4>
                <ul className="space-y-2">
                  {project.roiMetrics.costSavings.map((item, index) => (
                    <li key={index} className="text-sm text-muted-foreground flex items-start gap-2">
                      <CheckCircle className="w-4 h-4 text-[#8A0C1E] mt-0.5 flex-shrink-0" />
                      <span>{item}</span>
                    </li>
...
export default MathanElectronics; 